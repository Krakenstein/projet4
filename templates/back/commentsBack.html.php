<?php $title = 'Commentaires'; ?>
        ...
        <?php else: ?>
            ...
            <a href="index.php?action=comPage&amp;currentpage=<?= $currentpage - 1?>&amp;#titre" class="<?php if($currentpage === 1) echo 'hidden'?>"><div class="left"></div>Page précédente</a>
            <span class="currentPage"><?='Page ' . $currentpage . '/' . $totalpages?></span>
            <a href="index.php?action=comPage&amp;currentpage=<?= $currentpage + 1?>&amp;#titre" class="<?php if($currentpage === (int) $totalpages ) echo 'hidden' ?>">Page suivante<div class="right"></div></a>
            </div>
            ...
            <div class="comment">
                ...
                <div id="btnAction">
                    ...
                    <a href="index.php?action=deleteR&amp;id=<?= $com->id ?>" class="bouton">Retirer les signalements</a>
                </div>
            </div>
        <?php endforeach; ?>
            <div class="backNext<?php if($totalpages < 2) echo 'Hidden'?>">
