...
class EpisodeManager
{
    ...
    public function listBackEpisodes(int $offset, int $nbByPage):array//requête récupérer paginé la liste des épisodes avec des infos sur leurs commentaires associés
    {
        $this->bdd->setAttribute(PDO::ATTR_EMULATE_PREPARES, FALSE);
